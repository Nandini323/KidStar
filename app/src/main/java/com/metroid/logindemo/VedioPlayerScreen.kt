    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            LoginDemoTheme {
                ...
                val items = listOf(
                    Frontlistmodel(1,"Doremon Episode No. 1","When Doremon finally finds iceland...",R.drawable.do1, Color.Red),
                    Frontlistmodel(2,"Doremon Episode No. 2","Nobita always fail.. now what is the reaction we will see",R.drawable.do2, Color.Yellow),
                    Frontlistmodel(3,"Doremon Episode No. 3","Shizuka always support nobita.",R.drawable.do3, Color.Cyan),
                    Frontlistmodel(4,"Doremon Episode No. 4","Doremon finds a new friend dekesuki",R.drawable.do4, Color.Green),
                    Frontlistmodel(5,"Doremon Episode No. 5","Doremon gives its gadget to nobita what will happen",R.drawable.do5, Color.DarkGray),
                    Frontlistmodel(6,"Doremon Episode No. 6","Giyan finds the new mistarious stone.",R.drawable.do6, Color.Magenta)
                )
